...
const CC = () => {
  ...
  const handleDownload = async () => {
    try {
      const response = await axios.get(
        `https://www.joyseniorsecondary.ac.in/api/auth/getCc/${rollNumber}`
      );
      const data = response.data;
      window.open(data.cc_pdf, "_blank");
    } catch (error) {
      console.error("Error downloading CC:", error);
      setError("Error downloading CC");
    }
  };
  ...
  const handleView = async () => {
    try {
      ...
      console.error("Error viewing CC:", error);
      setError("Error viewing CC");
    }
  };
        ...
        <>
          <div className="container-fluid">
            <div className="row mx-2">
              ...
              <div className="col-lg-5 col-md-7 col-sm-12 certificate">
                <div className="card rounded-3 text-black d-flex align-items-center bg-light">
                  ...
                  <div className="col-lg-7 col-md-5 col-sm-6 mt-4">
                    <input
                      type="text"
                  ...
                  <div className="d-flex text-center ms-3 grid">
                    <button
                      type="button"
