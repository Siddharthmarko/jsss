...
//     try {
//       const response = await axios.get('https://jsss.nascorptechnologies.com/gw/gls/getBirthdayStuList?token=oZ32A4PWAWMzBymUru');
...
//         // Check if the dobParts array has the expected length
//         if (dobParts.length !== 3) {
//           console.warn(`Invalid date format for user: ${JSON.stringify(user)}`);
//           return false;
//         }
...
//           console.warn(`Invalid date values for user: ${JSON.stringify(user)}`);
//           return false;
//         }
...
//           console.warn(`Invalid date object for user: ${JSON.stringify(user)}`);
//           return false;
//         }
...
//     // 'Birthday2.mp3',
//     // 'Birthday3.mp3',
//     // 'Birthday4.mp3' // Add more audio sources as needed
//   ];
...
//    </div>
//  ) : (
//    // No birthdays today, display a message
//    <div className="text-container" style={{ textAlign: 'center', margin: '40px' }}>
//      <h1>No birthdays today. Check back tomorrow!</h1>
//    </div>
//  )}
