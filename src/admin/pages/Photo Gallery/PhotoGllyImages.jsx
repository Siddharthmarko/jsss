...
const PhotoGllyImages = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `https://www.joyseniorsecondary.ac.in/api/auth/photoBulkuploadImagesId/${id}`,
        formData
      );
  ...
  const handleView = () => {
    console.log(id);
    navigate(`/view-photo-gallery-images/${id}`);
  };
...
export default PhotoGllyImages;
