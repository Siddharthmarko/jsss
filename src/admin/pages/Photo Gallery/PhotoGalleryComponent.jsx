...
const PhotoGalleryComponent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("https://www.joyseniorsecondary.ac.in/api/auth/photogallry", form, {
        headers: {
  ...
  const handleActivity = () =>{
    navigate("/photo-gallery-main-part")
  }
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 col-12 mt-3">
              <div className="d-flex justify-content-around align-items-center mt-5">
                ...
                <button className="Insert" onClick={handleActivity}>Show all Photo Gallery</button>
              </div>
            </div>
          </div>
        </div>
