...
const ActivityMain = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://joyseniorsecondary.ac.in/api/auth/getactivity"
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://joyseniorsecondary.ac.in/api/auth/updateActivityId/${getId}`,
  ...
  const handleDelete = async (id) => {
    try {
      const response = await axios.delete(
        `https://joyseniorsecondary.ac.in/api/auth/deleteactivity/${id}`
      );
  ...
  const handleUploadImages = (id) => {
    console.log(id);
    navigate(`/upload-activity-images/${id}`);
  };
            ...
            <div className="col-lg-12 col-md-12 col-md-12 col-12">
              <table className="table">
                <thead className="table-dark">
                  <tr>
                    <th className="text-center">Activites Names</th>
