...
const ActivitImages = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `https://joyseniorsecondary.ac.in/api/auth/activityBulkuploadImagesId/${id}`,
        formData
      );
  ...
  const handleView = () =>{
    console.log(id);
    navigate(`/view-activity-images/${id}`)
  } 
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12">
              <div className="d-flex flex-column justify-content-center align-items-center mt-4 p-3">
                ...
                <button className="btn btn-success m-3" onClick={handleView}>View Images</button>
